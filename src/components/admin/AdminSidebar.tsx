...
import { User, Users, Settings, Palette, Eye, Save, Package, MessageSquare, Lock, Shield, Wrench, Download, FileText } from 'lucide-react';
...
const AdminSidebar: React.FC<AdminSidebarProps> = ({ 
  ...
  const menuItems = [
    ...
    { id: 'downloads-management', label: 'إدارة التنزيلات', icon: FileText, roles: ['مدير عام', 'مبرمج'] },
